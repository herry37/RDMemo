<%@ Page Language="C#" AutoEventWireup="true" CodeFile="70011.aspx.cs" Inherits="_7001_70011" %>
...
<body onload="show_sec()">
	...
	<tr style="background-color:#66FF66; height:24px">
		<td align="left" style="width:50%">客服姓名：<asp:Label ID="lb_mg_name" runat="server" Text=""></asp:Label></td>
		<td align="left" style="width:50%">經過時間：<span id="span_sec">0</span> sec</td>
	</tr>
	<tr><td colspan="2">
			<iframe id="if_msg" width="98%" src="700112.aspx?sid=<%=lb_cu_sid.Text%>&mg_sid=<%=lb_mg_sid.Text%>" scrolling="yes" frameborder="1" style="height:300px"></iframe>
		</td>
	</tr>
	<tr><td colspan="2">
			<iframe id="if_send" width="100%" src="700111.aspx?sid=<%=lb_cu_sid.Text%>&mg_sid=<%=lb_mg_sid.Text%>" frameborder="0" style="height:150px"></iframe>
		</td>
	</tr>
	</table>
