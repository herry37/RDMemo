<%@ Page Title="" Language="C#" MasterPageFile="Top.master" AutoEventWireup="true" CodeFile="joinMoreGrid.aspx.cs" Inherits="joinMoreGrid" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="left" Runat="Server">
    ...
    <%--<asp:ValidationSummary ID="ValidationSummary1" runat="server" ShowSummary="false" ShowMessageBox="true"/>--%>
     <asp:SqlDataSource ID="SqlDataSourcecity" runat="server" ConnectionString="<%$ ConnectionStrings:C501_04ConnectionString %>" SelectCommand="SELECT [縣市代碼], [縣市] FROM [縣市] WHERE ([顯示] = @顯示)">
        <SelectParameters>
            <asp:Parameter DefaultValue="true" Name="顯示" Type="Boolean" />
        </SelectParameters>
    </asp:SqlDataSource>
    <asp:SqlDataSource ID="SqlDataSourcetown" runat="server" ConnectionString="<%$ ConnectionStrings:C501_04ConnectionString %>" SelectCommand="SELECT [郵遞代碼], [郵遞區號], [鄉鎮市區] FROM [郵遞區號] WHERE ([縣市代碼] = @縣市代碼)">
        <SelectParameters>
    ...
    <div class="join-container">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlcity" runat="server" DataSourceID="SqlDataSourcecity" DataTextField="縣市" DataValueField="縣市代碼" 
                        ...
                        <asp:DropDownList ID="ddlarea" runat="server" DataSourceID="SqlDataSourcetown" DataTextField="鄉鎮市區" DataValueField="郵遞代碼" CssClass="input-sm"
