                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                ...
                                <asp:Label ID="Label6" runat="server" Text='<%# String.Format("{0:0}", Eval("單價")) %>' ForeColor="#ff0066" Font-Size="28"></asp:Label>                                
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                            <td>
                                ...
                                <asp:Button ID="btShoppingcar" runat="server" Text="加入購物車" OnClick="btShoppingcar_Click" CssClass="btn btn-primary btn-block" />
                            </td>
                        </tr>
                    </table>
