...
public partial class _7002_700211 : System.Web.UI.Page
{
 ...
 mErr = "參數傳送錯誤!返回主頁面\\n";
            ...
            if (Request["sid"] != null)
            {
                ...
                if (int.TryParse(Request["sid"], out cu_sid))
                {
                    ...
                    if (Chk_Cs_User(cu_sid, int.Parse(Session["mg_sid"].ToString())))
                        mErr = "";
                    else
                        mErr = "找不到客服要求紀錄!\\n";
                }
            ...
            if (mErr != "")
                ClientScript.RegisterStartupScript(this.GetType(), "ClientScript", "alert(\"" + mErr + "\");parent.location.replace(\"7002.aspx\");", true);
        }
    }
    ...
    protected void bn_smsg_Click(object sender, EventArgs e)
    {
        ...
        if (tb_cm_desc.Text.Trim() != "")
        {
            ...
            if (cu_rtn == "2")
            {
                ...
                ClientScript.RegisterStartupScript(this.GetType(), "ClientScript", "alert(\"交談已結束，請重新提出客服要求！\");parent.location.replace(\"7002.aspx\");", true);
            }
            else
            {
                ...
                using (SqlConnection Sql_Conn = new SqlConnection(WebConfigurationManager.ConnectionStrings["APPSYSConnectionString"].ConnectionString))
                {
                    using (SqlCommand Sql_Command = new SqlCommand())
                    {
                        ...
                        SqlString += "(@cu_sid, getdate(), 2, @cm_desc)";
