<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmployAccount.aspx.cs" Inherits="EmployAccount" %>
                    ...
                    <table style="width: 790px" class="well table">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input id="btn2" type="button" value="取消" onclick="window.close()" class="btn btn-default"/>
                                <%--<asp:Button ID="Button2" runat="server" Text="取消" CssClass="btn btn-default" OnClientClick="window.close()" />--%>
