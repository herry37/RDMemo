...
public partial class custModifyData : System.Web.UI.Page
{
    ...
    protected void DataList1_UpdateCommand(object source, DataListCommandEventArgs e)
    {
        ...
        DropDownList u_addcity = (DropDownList)DataList1.FindControl("ddl3");
        DropDownList u_addarea = (DropDownList)DataList1.FindControl("ddl4");
        ...
        Sqlregistered.UpdateParameters["住址其他"].DefaultValue = u_add.Text;
    ...
    {
        DropDownList ddl4 = (DropDownList)DataList1.FindControl("ddl4");
        Label labareano = (Label)DataList1.FindControl("lab4");
